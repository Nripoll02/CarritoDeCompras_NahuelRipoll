    ...
    public class Menu
    {
        ...
        public void MostrarMenu(Camisas camisas, Carrito carrito)
        {
            do
            {
                ...
                Console.WriteLine("(4) Realizar comprar");
                Console.WriteLine("--------------------------------------------------");
                ...
                Console.WriteLine("'     '- Precio final con descuento: $" + carrito.CuentaFinal);
                ...
                {
                    Console.WriteLine("Existe un error.Debe ingresar un numero positivo");
